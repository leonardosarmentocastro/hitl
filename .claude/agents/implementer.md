...
- **Local gates before you report done.** Run every gate the standards mandate — in this
  repository the unit, e2e and story suites — unless the plan's Global Constraints state
...
2. gates run and results (e.g. `pnpm test ✔ · pnpm test:stories ✔ · e2e not applicable`)
